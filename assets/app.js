...
function eventExtras(eventData){
    ...
    if(eventData.description){
        retStr+=`${eventData.description}<br><a href=${eventData.url}>Click here for event site.</a>`
    }else{
        retStr+=`No Description Provided. <br><a href=${eventData.url}>Click here for event site.</a>`
    }
...
$("#thisweekBtn").on('click',function(){
    ...
    document.getElementById("thisweekBtn").style.backgroundColor = "gray"
    document.getElementById("nextweekBtn").style.backgroundColor = ""
    document.getElementById("allBtn").style.backgroundColor = ""
    // console.log(myParam.date);
});
$("#nextweekBtn").on('click',function(){
    ...
    document.getElementById("todayBtn").style.backgroundColor = ""
    document.getElementById("thisweekBtn").style.backgroundColor = ""
    document.getElementById("nextweekBtn").style.backgroundColor = "gray"
    document.getElementById("allBtn").style.backgroundColor = ""
    // console.log(myParam.date);
});
$("#allBtn").on('click',function(){
    ...
    document.getElementById("thisweekBtn").style.backgroundColor = ""
    document.getElementById("nextweekBtn").style.backgroundColor = ""
    document.getElementById("allBtn").style.backgroundColor = "gray"
